...
import Lsimulator.server.telnet.TelnetServer;
...
public class Server {
	...
	public static void main(final String[] args) throws Exception {
		...
		// LsimulatorDatabaseFactory初期設定
		LsimulatorDatabaseFactory.setDatabaseSettings(Config.DB_DRIVER, Config.DB_URL, Config.DB_LOGIN, Config.DB_PASSWORD);
		LsimulatorDatabaseFactory.getInstance();
