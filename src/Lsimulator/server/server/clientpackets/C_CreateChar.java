...
import Lsimulator.server.server.BadNamesList;
...
import Lsimulator.server.server.utils.CalcInitHpMp;
...
public class C_CreateChar extends ClientBasePacket {
	...
	private static void initNewChar(ClientThread client, PcInstance pc) throws IOException, Exception {
		...
		if (pc.isWizard()) { // WIZ
			...
			LsimulatorSkills l1skills = SkillsTable.getInstance().getTemplate(4); // EB
