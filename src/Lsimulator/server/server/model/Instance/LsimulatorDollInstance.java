...
public class LsimulatorDollInstance extends LsimulatorNpcInstance {
	...
	public LsimulatorDollInstance(LsimulatorNpc template, LsimulatorPcInstance master, int itemId,
			int itemObjId) {
		super(template);
	...
	public void deleteDoll() {
		...
		if (LsimulatorMagicDoll.isHpRegeneration(_master)) {
			((LsimulatorPcInstance) _master).stopHpRegenerationByDoll();
		}
		if (LsimulatorMagicDoll.isMpRegeneration(_master)) {
			((LsimulatorPcInstance) _master).stopMpRegenerationByDoll();
		}
		if (LsimulatorMagicDoll.isItemMake(_master)) {
			((LsimulatorPcInstance) _master).stopItemMakeByDoll();
		}
