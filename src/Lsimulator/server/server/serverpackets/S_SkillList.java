...
import static Lsimulator.server.server.Opcodes.S_OPCODE_ADDSKILL;
import static Lsimulator.server.server.Opcodes.S_OPCODE_DELSKILL;
...
public class S_SkillList extends ServerBasePacket {
	 ...
	 */
	public S_SkillList(boolean Insert, LsimulatorSkills... skills) {
		if (Insert)
		...
		for (LsimulatorSkills skill : skills) {
