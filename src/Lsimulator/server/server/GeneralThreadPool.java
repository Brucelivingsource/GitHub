...
import Lsimulator.server.server.model.monitor.LsimulatorPcMonitor;
...
public class GeneralThreadPool {
	...
	public ScheduledFuture<?> pcSchedule(LsimulatorPcMonitor r, long delay) {
		try {
			if (delay <= 0) {
				_executor.execute(r);
				return null;
	...
	public ScheduledFuture<?> pcScheduleAtFixedRate(LsimulatorPcMonitor r, long initialDelay, long period) {
