...
public class LsimulatorPetType {
	private final int _baseNpcId;

	private final LsimulatorNpc _baseNpcTemplate;
	...
	public LsimulatorPetType(int baseNpcId, String name, int itemIdForTaming,
	...
	public LsimulatorNpc getBaseNpcTemplate() {
