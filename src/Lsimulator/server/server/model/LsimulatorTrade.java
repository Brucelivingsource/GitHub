...
public class LsimulatorTrade {
	private static LsimulatorTrade _instance;

	public LsimulatorTrade() {
	}

	public static LsimulatorTrade getInstance() {
		if (_instance == null) {
			_instance = new LsimulatorTrade();
		}
		return _instance;
	}
