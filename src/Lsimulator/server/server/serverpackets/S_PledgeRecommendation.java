...
import static Lsimulator.server.server.Opcodes.S_OPCODE_PLEDGE_RECOMMENDATION;
		...
		case 2: // 查詢
			try {
				...
				while(rs.next()){
					...
					LsimulatorClan clan = LsimulatorWorld.getInstance().getClan(rs.getString("clan_name"));
