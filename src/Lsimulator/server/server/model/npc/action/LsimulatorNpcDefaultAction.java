...
public class LsimulatorNpcDefaultAction {
	static Logger _log = Logger.getLogger(LsimulatorNpcDefaultAction.class.getName());
	...
	private static final LsimulatorNpcDefaultAction _instance = new LsimulatorNpcDefaultAction();

	private LsimulatorNpcDefaultAction() {
		loadAction();
	}

	public static LsimulatorNpcDefaultAction getInstance() {
		return _instance;
	}
