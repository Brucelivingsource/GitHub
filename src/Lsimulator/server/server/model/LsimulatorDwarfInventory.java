...
public class LsimulatorDwarfInventory extends LsimulatorInventory {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public LsimulatorDwarfInventory(LsimulatorPcInstance owner) {
		_owner = owner;
	}
	...
	private static void present(List<String> accountList, int itemid,
		...
		LsimulatorItem itemtemp = ItemTable.getInstance().getTemplate(itemid);
	...
	private static Logger _log = Logger.getLogger(LsimulatorDwarfInventory.class.getName());
