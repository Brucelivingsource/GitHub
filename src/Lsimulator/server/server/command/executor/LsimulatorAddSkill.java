 ...
 * TODO: 翻譯 GM指令：增加魔法
 */
public class LsimulatorAddSkill implements LsimulatorCommandExecutor {
	private LsimulatorAddSkill() {
	}

	public static LsimulatorCommandExecutor getInstance() {
		return new LsimulatorAddSkill();
	}
	...
	public void execute(PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (pc.isCrown()) {
				...
				{
					LsimulatorSkills l1skills = SkillsTable.getInstance().getTemplate(cnt); // 技能情報取得
