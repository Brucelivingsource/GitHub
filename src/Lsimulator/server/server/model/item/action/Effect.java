...
public class Effect {
	...
	public static void useEffectItem(LsimulatorPcInstance pc, LsimulatorItemInstance item) {
		...
		int gfxid = 0;
		switch(itemId) {
			case LsimulatorItemId.POTION_OF_EXP_150: // 150%神力藥水
			case LsimulatorItemId.POTION_OF_EXP_175: // 175%神力藥水
			case LsimulatorItemId.POTION_OF_EXP_200: // 200%神力藥水
			case LsimulatorItemId.POTION_OF_EXP_225: // 225%神力藥水
			case LsimulatorItemId.POTION_OF_EXP_250: // 250%神力藥水
				...
				break;
			case LsimulatorItemId.BLESS_OF_MAZU: // 媽祖祝福平安符
				skillId = EFFECT_BLESS_OF_MAZU;
				time = 2400;
				gfxid = 7321;
				deleteRepeatedSkills(pc, skillId); // 與妖精屬性魔法相衝！
				break;
			case LsimulatorItemId.POTION_OF_BATTLE: // 戰鬥藥水
				skillId = EFFECT_POTION_OF_BATTLE;
				time = 3600;
				gfxid = 7013;
				deleteRepeatedSkills(pc, skillId); // 與神力藥水等相衝
				break;
			case LsimulatorItemId.SCROLL_FOR_STRENGTHENING_HP: // 體力增強卷軸
			case LsimulatorItemId.SCROLL_FOR_STRENGTHENING_MP: // 魔力增強卷軸
			case LsimulatorItemId.SCROLL_FOR_ENCHANTING_BATTLE: // 強化戰鬥卷軸
				skillId = itemId - 42999;
				time = 3600;
				gfxid = itemId - 40014;
