...
public class NPCTalkDataTable {
	...
	private Map<Integer, LsimulatorNpcTalkData> _datatable = Maps.newMap();
	...
	private void parseList() {
		...
		try {
			...
			while (rs.next()) {
				LsimulatorNpcTalkData l1npctalkdata = new LsimulatorNpcTalkData();
	...
	public LsimulatorNpcTalkData getTemplate(int i) {
