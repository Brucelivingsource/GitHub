...
public class LsimulatorGuardInstance extends LsimulatorNpcInstance {
	/**
	 * 
	 */
	...
	public void setTarget(LsimulatorPcInstance targetPlayer) {
		if (targetPlayer != null) {
			_hateList.add(targetPlayer, 0);
			_target = targetPlayer;
		}
	...
	public LsimulatorGuardInstance(LsimulatorNpc template) {
		super(template);
	}
	...
	private boolean checkHasCastle(LsimulatorPcInstance pc, int castleId) {
