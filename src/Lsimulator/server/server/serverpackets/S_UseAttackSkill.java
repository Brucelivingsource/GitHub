...
public class S_UseAttackSkill extends ServerBasePacket {
	...
	public S_UseAttackSkill(LsimulatorCharacter cha, int targetobj, int x, int y, int[] data) {
		buildPacket(cha, targetobj, x, y, data, true);
	}

	public S_UseAttackSkill(LsimulatorCharacter cha, int targetobj, int x, int y, int[] data, boolean withCastMotion) {
