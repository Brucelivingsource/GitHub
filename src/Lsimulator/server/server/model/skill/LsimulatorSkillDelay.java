...
// LsimulatorSkillDelay

public class LsimulatorSkillDelay {

	private LsimulatorSkillDelay() {
	}

	static class SkillDelayTimer implements Runnable {
		private LsimulatorCharacter _cha;

		public SkillDelayTimer(LsimulatorCharacter cha, int time) {
			_cha = cha;
		}
	...
	public static void onSkillUse(LsimulatorCharacter cha, int time) {
