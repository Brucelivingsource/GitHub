 ...
 * 
 */
package Lsimulator.server.server.model.identity;

/**
 * <h1>string-c字串編號 SystemMessage
 */
public class LsimulatorSystemMessageId {
	/** 王族 */
	...
	/** 請瀏覽天堂網站 http://www。lineage。com。tw/ 。 */
	...
	/** 一旦成為玩家殺手，將永遠地成為玩家殺手。你仍然要當玩家殺手嗎？ (Y/N) */
	...
	/** 你尚未準備好。還是要與%0血盟戰爭嗎？(Y/N) */
	public static final int $266 = 266;
	/** %0血盟在城堡裡隱藏伏兵。是否接戰？(Y/N) */
	...
	/** 你的時數卡已經用完，如想要繼續遊戲，請至７-ＥＬＥＶＥＮ購買。 */
	public static final int $306 = 306;
	/** 您可使用的剩餘時間已經快用完了。剩餘使用時間為 %d個小時 %d分。若若不希望中斷而繼續使用此遊戲，請在過期之前儲值。 */
	...
	/** 別的PC使用此IP位址。請至天堂客戶服務部(0800031500)詢問。 */
	...
	/** \f3請注意!!!GM或工作人員在遊戲內不會詢問使用者的帳號密碼以及索取道具。請勿告訴任何人您的帳號及密碼。 */
	...
	/** 你不能使用舊的密碼當作新的密碼。請再次輸入密碼。 */
	public static final int $342 = 342;
	/** \f1當聲響響起的時候你無法使用其他的物品。 */
	public static final int $343 = 343;
	/**
	 * 在天堂裡為了保密使用者的密碼，且使用者忘記密碼時，在線上直接變更密碼而套用使用者本人才可猜的質問和回答制度。
	 * 請使用者注意觀看在現在猜迷登錄畫面上出現的注意此項之後登錄本人才可猜出來的問答。Ncsoft不負責使用者未遵守而發生的所有狀況。
	 */
	...
	/** 個人月租的剩下時間為 %d個小時 %d分。若想未有中斷而繼續進行玩此遊戲，請在過期之前儲值。 */
	public static final int $437 = 437;
	/**
	 * 本公司受到貴下在網路咖啡廳利用天堂的時候故意不付網咖使用費的報警。如上行為則屬於刑法第347條的欺詐罪。若貴下沒有做過如上行為， [ 15
	 * ]日之內與本公司(0800031500，
	...
	/** 請注意！您的點數剩下 %d 分鐘。若結束您使用的時間，強制被關閉此遊戲。請大家注意時間。謝謝。 */
	...
	/** 您因盜用帳號或點數不足，目前停用您的帳號。若想要使用您的帳號，請洽遊戲橘子客服中心。 */
	...
	/**
	 * @使用者將使用者的帳號不可以使用在不正當的地方。@ 使用者不可侵犯第3者的地積財?權。
	 *                           <在天堂使用者同意書之中>根據如上天堂使用同意書由%s的駭客報警
	 *                           ，被停用顧客的帳號。欲知仔細內容
	 *                           ，請透過天堂網站的駭客報警中心，以電話或電子郵件詢問負責伺服自的GM。
	 */
	public static final int $490 = 490;
	/**
	 * @ 使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。-利用程式上bug <天堂使用者同意書的義務中>
	 * 根據天堂同意書，被停用使用者的帳號。利用bug的行為，也許將導致遊戲Service上帶來嚴重的障礙與遊戲平衡崩潰。請以電子郵件詢問負責伺服器GM。
	 */
	public static final int $491 = 491;
	/**
	 * @ 使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。-將使用者的帳號讓度予其他人或販賣帳號的行為
	 * <天堂使用者同意書的義務中>根據天堂使用者同意書
	 * ，使用者的帳號被停用。現金交易會導致盜用帳號和利用bug的事件等許多事件。請以電子郵件詢問負責伺服器GM。
	 */
	public static final int $492 = 492;
	/**
	 * @ 使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。-在遊戲裡所獲得的道具買賣行為<天堂使用者同意書的義務中>根據天堂使用者同意書
	 * ，使用者的帳號被停用。現金交易會導致盜用帳號和利用bug的事件以及欺騙玩家等許多事件。請以電子郵件詢問負責伺服器GM。
	 */
	public static final int $493 = 493;
	/**
	 * 本公司為了提供給玩家更好的服務，運作天堂駭客中心。由本公司的駭客中心來解決帳號盜用的事件。雖然本公司未有對於帳號盜用事件的法律義務，
	 * 但是為了更好的天堂服務及加強服務
	 * ，而經營此，但最近因使用者的虛偽報警而導致經營上的困擾。有報警。但經過連上遊戲的資料，結果沒有紀錄跟報警相關資料。因判定為
	 * %s的虛偽報警，使用者的帳號被停用
	 * 。請再次確認報警的內容，是否有寫下的日期和內容不對。請透過天堂網站駭客報警中心或以電子郵件的方式詢問負責伺服器的GM。
	 */
	public static final int $494 = 494;
	/** @使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。-將使用者的帳號讓度予其他人或現金販賣行為-在遊戲裡所獲得的道具買賣行為<天堂使用者同意書的義務中>根據天堂使用者同意書，使用者的帳號被停用。現金交易會導致盜用帳號和利用bug的事件以及欺騙玩家等許多事件。請以電子郵件詢問負責伺服器GM。 */
	public static final int $495 = 495;
	/**
	 * @ 使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為- 利用程式上bug
	 * <天堂使用者同意書的義務中>根據天堂同意書，被停用使用者的帳號
	 * 。利用bug的行為，也許將導致遊戲Service上帶來嚴重的障礙與遊戲平衡崩潰。關於利用bug的行為請以電子郵件詳細的詢問負責伺服器GM
	 * ，能否使用帳號。
	 */
	public static final int $496 = 496;
	/**
	 * @使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。-欺負或威脅其他使用者，持續給予特定玩家痛苦和給予特定玩困擾的行為。< 
	 *                                                                      天堂使用者同意書的義務中
	 *                                                                      >
	 *                                                                      根據天堂同意書
	 *                                                                      ，
	 ...
	 * 本公司為了提供給玩家更好的服務，運作天堂駭客中心。由本公司的駭客中心來解決帳號盜用的事件。雖然本公司未有對於帳號盜用事件的法律義務，
	 * 但是為了更好的天堂服務及加強服務
	 * ，而經營此，但最近因使用者的虛偽報警而導致經營上的困擾。因此駭客報警本人在5天之內沒有寄至本公司身分證謄本，即判定為虛偽報警
	 * ，永遠停用報警使用者之帳號。 因判定為 %s的虛偽報警，使用者的帳號被停用。請再次確認報警的內容，是否有寫下的日期和內容不對。
	 * 請透過天堂網站駭客報警中心或以電子郵件的方式詢問負責伺服器的GM。
	 */
	public static final int $498 = 498;
	/**
	 * @ 使用者除了由公司提供的以服務為目的的用途之外不可以做如下的行為。- 欺負或威脅其他使用者，持續給予特定玩家痛苦和給予特定玩困擾的行為。<
	 * 天堂使用者同意書的義務中>
	 * 根據天堂同意書，被停用使用者的帳號。在遊戲裡的欺騙行為屬於持續給予特定玩家痛苦的行為，此行為就是妨礙進行正常遊戲的行為。
	 * 請以電子郵件詢問負責伺服器GM。
	 */
	...
	/** 由手機結帳盜用報警被停用使用者的帳號。請第二天詢問客服中心(0800031500)。請以電子郵件詢問其他詢問此項。 */
	...
	/**
	 * 因您的血盟擁有的血盟小屋屬於本領主領土，因此若要使用此血盟小屋，必須繳稅金%n 請將稅金 %0金幣在 %1月 %2日
	 * %3點之前透過女僕來繳納。%n%n
	 */
	public static final int $515 = 515;
	/** 您尚未繳房子的稅金金幣 %0。 %n若在 %1月 %2日 %3點之內沒有繳稅金，將強制取回血盟小屋，所以請注意。%n%n */
	public static final int $516 = 516;
	/** 你既然沒有繳稅金 %0金幣。所以將回收你對血盟小屋的所有權，這是你自己抗拒本地領主的命令而造成的。%n%n */
	...
	/** 有人提出比您高的金額，因此無法給你購買權。%n因為您參與拍賣沒有得標，所以還給你 %0金幣。%n謝謝。%n%n */
	public static final int $525 = 525;
	/** 您的血盟小屋拍賣成功，目前無法再擁有血盟小屋。因此不得不剝奪您的血盟小屋所有權，請見諒。%n謝謝%n%n */
	...
	/** 在拍賣期間並沒有出現提出適當價格的人，所以拍賣取消。%n但是您目前處於無法擁有血盟小屋的狀態，因此無法還給你小屋的所有權。%n請見諒。 */
	public static final int $529 = 529;
	/** 必須先繳稅金。 */
	public static final int $530 = 530;
	/** \f1交易的物品過重，你無法再放置任何物品。 */
	...
	/** 你已經殺了 %0 人。 如果你PK的次數達到 %1， 你將會被打入地獄。 */
	public static final int $551 = 551;
	/** 因為你已經殺了 %0 人所以被打入地獄。 你將在這裡停留 %1 分鐘。 */
	...
	/** \f1你的帳號將在 %d 分鐘後被中止。 如果你想繼續遊戲， 請增加您的點數。 */
	...
	/** 請瀏覽天堂網站 http://www。lineage。com。hk/ 。 */
	public static final int $593 = 593;
	/** center@ncgamania。com。hk */
	public static final int $594 = 594;
	/** 你的時數卡已經用完，如想要繼續遊戲，請至各大便利商店購買。 */
	public static final int $595 = 595;
	/** 別的PC使用此IP位址。請至天堂客戶服務部(852-28936288)詢問。 */
	public static final int $596 = 596;
	/**
	 * 您的"天堂"月租時間已完結了。若想繼續進行此遊戲，請至"天堂"網站內的GD2S開卡中心作點數增值及轉移。http://www。lineage。
	 * com。hk。
	 */
	public static final int $597 = 597;
	/** 您的"天堂"遊戲帳號之剩餘點數為 %d 點。若不希望因點數被扣完而造成遊戲中斷，請在點數被扣完前進行增值。 */
	public static final int $598 = 598;
	/**
	 * 本公司受到貴下在網路咖啡廳利用天堂的時候故意不付網咖使用費的報警。如上行為則屬於刑法第347條的欺詐罪。若貴下沒有做過如上行為， [ 15
	 * ]日之內與本公司(852-28936288，
	...
	/** 由信用卡盜用報警被停用使用者的帳號。請詢問天堂客服中心(852-28936288)。 */
	public static final int $601 = 601;
	/** 由手機結帳盜用報警被停用使用者的帳號。請第二天詢問客服中心(852-28936288)。請以電子郵件詢問其他詢問此項。 */
	...
	/** 道具/魔法 熱鍵設定 任意設定F5~F12鍵 快速使用該物件 */
	...
	/** 使用者帳號因網路銀行的帳號被盜用，而被停止使用。請洽天堂帳號處理部門(0800-031-500)。 */
	public static final int $620 = 620;
	/**
	 * 使用者的服務帳號在一年之間沒有任何上線紀錄時，根據同意書該使用者之服務帳號將會被刪除。若要再次使用，請您把可證明您身分之證件傳真到本公司，
	 * 包括您的服務帳號與相關事宜。收到傳真之前，本公司不會復原您的服務帳號。
	 */
	...
	/**
	 * 您的帳號一年內未上線將會刪除。為了能再使用該帳號，必須將能證明本人身分的身分證明文件影印本Fax至(02)8226-9936
	 * 。傳真時，請詳細的寫下帳號和您的需求。若收到傳真之前已被刪除的話將無法回復。
	 */
	public static final int $628 = 628;
	/** 您無法使用天堂簡訊服務。欲知詳細原因，請至sms。gamania。com 網頁上確認。 */
	...
	/** \f1你的結婚戒指沒有和其他人配對，請先找到對象再連上戒指。 */
	public static final int $652 = 652;
	/** 若你離婚，你的結婚戒指將會消失。你決定要離婚嗎？(Y/N) */
	...
	/**
	 * 由顧客的要求而被停用顧客的帳號。為了再度使用帳號，必須將能證明本人身分的身份證影印本請至
	 * Fax(852-2836-5366)。傳送Fax的時候，請簡單的寫下帳號和內容。
	 */
	...
	/** 血盟成員想要與你一起瞬間移動，你要一起移動嗎？(Y/N) */
	public static final int $744 = 744;
	/** 目前已超使用限制時間。等一下遊戲將自動結束請先到安全的地點登出遊戲。 */
	public static final int $745 = 745;
	/** 超過指定時間而遊戲結束。 */
	public static final int $746 = 746;
	/** \f1\f1您剩餘的時間為%d分鐘。所指定的使用限制時間將結束，請先登出後再進行遊戲。 */
	public static final int $747 = 747;
	/** 你的血盟成員想要傳送你。你答應嗎？(Y/N) */
	public static final int $748 = 748;
	/** 收信者的號碼型式錯誤... */
	public static final int $749 = 749;
	/** 天堂Non PvP版本只有滿12歲以上的使用者才能使用。您的天堂Non PvP版本的角色與道具情報在您成為滿12歲之前，本公司將為您妥善保管。 */
	public static final int $750 = 750;
	/** 天堂PvP版本只有滿15歲以上的使用者才可使用。您的天堂PvP版本的角色與道具情報在您滿15歲之前，本公司將為您妥善保管。 */
	public static final int $751 = 751;
	/** 本伺服器只有滿18歲以上的使用者才能使用。請利用15歲/12歲 使用者的伺候器。 */
	...
	/** 本伺服器要經過滿18歲以上認證後才能使用，請在%s認證是否為滿18歲以上。 */
	...
	/** 加入血盟的話，目前血盟倉庫中的所有道具會消失。你真正要加入嗎？ */
	...
	/** 選擇活動的伺服器是網咖專用伺服器，只能在天堂授權網咖裡連結，詳細內容請洽天堂客服中心。 */
	public static final int $809 = 809;
	/** nProtect相關檔案原始化發生錯誤，請使用管理者帳號來登入執行遊戲，謝謝！ */
	...
	/** 請輸入密碼(6位數)，如果沒有密碼請直接按”OK”。 */
	public static final int $838 = 838;
	/** 請輸入新密碼(6位數，只能用滑鼠點選小鍵盤才能輸入)。 */
	public static final int $839 = 839;
	/** 請再次輸入新密碼(6位數，只能用滑鼠點選小鍵盤才能輸入)。 */
	public static final int $840 = 840;
	/** 請輸入密碼(6位數，只能用滑鼠點選小鍵盤才能輸入)。 */
	...
	/** 想要\f2%s\f>幾個呢？(1-%u，Enter=全部，Esc=取消) */
	...
	/**
	 * 此帳號由於盜用他人資訊註冊等相關原因已被臨時停止。若與相關事由無關，則請進行本人身分確認步驟，相關的疑問事項請與本公司的客戶服務中心取得聯繫。<BR>
	 * <BR>
	...
	/** 天堂的帳戶名需至少5字以上。請輸入正常的帳戶名。 */
	public static final int $1036 = 1036;
	/** 您的帳戶已被確認進行過現金/帳戶/人物名稱/服務期之間的交易1次，被凍結7天。詳細情況請以電子郵件的形式諮詢天堂網站的客服中心。 */
	public static final int $1037 = 1037;
	/** 您的帳戶已被確認進行過現金/帳戶/人物名稱/服務期之間的交易2次，被凍結30天。詳細情況請以電子郵件的形式諮詢天堂網站的客服中心。 */
	public static final int $1038 = 1038;
	/** 您的帳戶已被確認進行過現金/帳戶/人物名稱/服務期之間的交易3次，被永久凍結。詳細情況請以電子郵件的形式諮詢天堂網站的客服中心。 */
	public static final int $1039 = 1039;
	/**
	 * 您的帳戶已被確認進行過現金交易(人物名稱，服務期之間的交易等)1次，被凍結30天。今後若再次發現以您的身分號碼註冊的帳戶上出現同樣事由，
	 * 會立刻對帳戶進行永久凍結的嚴厲措施，請務必注意。詳細情況請以電子郵件的形式諮詢天堂網站的客服中心。
	 */
	public static final int $1040 = 1040;
	/**
	 * 您的帳戶已被確認進行過現金交易(人物名稱，服務期之間的交易等)2次以上，故已被永久凍結。相關內容已在之前的制裁當中提及到，
	 * 詳細情況請以電子郵件的形式諮詢天堂網站的客服中心。
	 */
	public static final int $1041 = 1041;
	/**
	 * 您的帳戶已被確認進行過現金交易(人物名稱，服務期之間的交易等)，被凍結30天，並處於等待本人進行認證的狀態。
	 * 只要通過天堂網站進行本人身分的認證即可正常連接遊戲，請進行網站上的本人認證步驟。
	 */
	...
	/**
	 * 玩家(用戶)不得在遊戲內使用或者意圖放置有礙遊戲秩序(善良風俗)，以及影響他人使用權益(社會秩序)的任何傳輸內容。<BR>
	 * <BR>
	...
	/**
	 * @玩家所登記之身份證字號下的帳號目前無法使用。為了避免玩家以不正常的方式進行遊戲，因此針對該身分證字號下的帳號做出停權的措施。<BR><BR>若有妨礙遊戲進行，或者該行為影響到其他正常玩家的權益，使用不當的方式獲取利益，以及使用外掛程式(不法程式)影響遊戲正常營運的行為等等。<BR><BR>也就是說，登記在玩家身份證字號下的帳號違反 
	 *                                                                                                                                                                         <
	 *                                                                                                                                                                         天堂使用者規章
	 *                                                                                                                                                                         >
	 *                                                                                                                                                                         ，
	...
	/**
	 * @玩家不得將營運商所提供的遊戲服務，用在其他任何的營利目的上。<BR><BR> -
	 *                                         散佈個人或非營運商的第三者所開發的軟體或硬體程式來進行遊戲，或者鼓勵其他玩家使用該程式進行遊戲
	 *                                         (遊戲內打怪等)，
	 *                                         也不得以廣告的方式鼓勵玩家使用這些非官方所提供的程式<BR>
	 * <BR>
	 *                                         <天堂使用者規章 第3張 第14條第10項><BR>
	 * <BR>
	 *                                         依照上列使用者規章並將該帳號停權。<BR>
	 * <BR>
	 *                                         使用非法程式或者修改客戶端程式會嚴重影響遊戲的進行。若有任何問題，
	 *                                         請詢問客服相關人員(詢問管理該伺服器的管理員)。
	 */
	public static final int $1062 = 1062;
	/**
	 * @玩家不得將營運商所提供的服務用在下列的目的上。<BR><BR> 
	 *                                  -散佈個人或非營運商的第三者所開發的軟體或硬體程式來進行遊戲，或者鼓勵其他玩家使用該程式進行遊戲
	 *                                  (遊戲內打怪等)，也不得以廣告的方式鼓勵玩家使用這些非官方所提供的程式<BR>
	 * <BR>
	...
	/** 風的力量吹襲著身體，使目標的迴避率降低至０。 */
	public static final int $1067 = 1067;
	/** 水的防護圍繞著身體，提高本身的迴避率５點。 */
	public static final int $1068 = 1068;
	/** 污濁的水侵蝕著身體，使所有的治癒效果減半。 */
	public static final int $1069 = 1069;
	/** 暫時提升本身的迴避率１５點，裝備盾牌才有效果。 */
	public static final int $1070 = 1070;
	/** 似鷹眼般的專注於目標的動作上，一有機會將以本身最高攻擊力的兩倍反擊回去，裝備雙手劍才有效果。 */
	public static final int $1071 = 1071;
	/** 烈焰的氣息似靈魂般融入武器裡，讓武器能發揮出最強大的破壞力。 */
	public static final int $1072 = 1072;
	/** 此伺服器不能刪除角色。 */
	public static final int $1073 = 1073;
	/**
	 * 玩家您好～天堂管理人員。該帳號的持有人已循正常途徑，要求臨時停權，因此暫時無法使用。詳情請以郵件訊問或者請洽客服中心。客服中心 :
	 * 1600-0020 (平日 : am 9:00 ~ pm 7:00，週六 : am 9:00 ~ pm 1:00)
	 */
	public static final int $1074 = 1074;
	/** 活動期間中以各伺服器別只能產生1個角色，開啟新伺服器後可創立其他角色。 */
	...
	/** 太陽神阿波羅(Deporoju) 2世大聲喊話。"為了亞丁擊退拉斯塔巴德的首相們的英雄敬禮!" */
	public static final int $1092 = 1092;
	/** 太陽神阿波羅(Deporoju) 2世大聲喊話。"對拉斯塔巴德進前線攻擊的英雄敬禮!" */
	public static final int $1093 = 1093;
	/** 太陽神阿波羅(Deporoju) 2世大聲喊話。"對擊退拉斯塔巴德敵軍的英雄敬禮!" */
	public static final int $1094 = 1094;
	/** 接受君主的祝福時無法使用變身卷軸。 */
	public static final int $1095 = 1095;
	/**
	 * 此帳號是手機(ARS) 結帳後，未繳費而臨時被限制的狀態。請繳交向未付款的金額，繳交證明文件請依 fax(Fax 02-2186-3499)
	 * 傳送過來後請與客服專線(1600-0020)連絡。
	 */
	...
	/** 取消進行中 : 綜合服務取消申請完畢目前作業進行中。 */
	public static final int $1105 = 1105;
	/** 鎖定綜合服務 : 目前鎖定綜合服務的狀態。相關帳號無法使用遊戲服務。 */
	public static final int $1106 = 1106;
	/** 休免帳號 : 登入之帳號目前是休免的狀態。在網頁須要解除休免狀態。 */
	public static final int $1107 = 1107;
	/** 您的帳號在天堂遊戲服務使用中向位同意的狀態。PlayNC 在網頁(www。plaync。co。kr)中 申請同意遊戲後再重登。 */
	public static final int $1108 = 1108;
	/** 您所登入的帳號是以 PlayNC 綜合帳號所轉換的帳號。請在輸入帳號下方確認 'PlayNC 綜合帳號' 後，以PlayNC 綜合帳號登入。 */
	public static final int $1109 = 1109;
	/** 數量不足 */
	public static final int $1110 = 1110;
	/** STR_BLOCK_TERM_BOTS */
	public static final int $1111 = 1111;
	/** 您的帳號是依客戶的要求下停止全部遊戲服務設定的狀態。更詳細事項請透過客服專線(Tel。1600-0200)洽詢。 */
	public static final int $1112 = 1112;
	/**
	 * 您的帳號確認到使用了非法系統而鎖住了全部遊戲服務因此無法使用的狀態。更詳細事項請透過 PlayNC 網頁(www。plaync。co。kr)
	 * 客服洽詢。
	 */
	public static final int $1113 = 1113;
	/**
	 * 您的帳號是使用有關非法系統而鎖住約10天間無法使用全部遊戲服務的限制狀態。往後發現同樣事由時永久限制處置請留意，更詳細事項請透過 PlayNC
	 * 網頁(www。plaync。co。kr) 客服洽詢。
	 */
	public static final int $1114 = 1114;
	/**
	 * 您的帳號確認到交易帳號內容而鎖住了全部遊戲服務因此無法使用的狀態。更詳細事項請透過 PlayNC 網頁(www。plaync。co。kr)
	 * 客服洽詢。
	 */
	public static final int $1115 = 1115;
	/** 您的帳號是被盜帳號而鎖住了全部遊戲服務因此無法使用的狀態。更詳細事項請透過PlayNC 網頁(www。plaync。co。kr) 客服洽詢。 */
	public static final int $1116 = 1116;
	/**
	 * 您的帳號是確認到利用別人名義加入的而暫時鎖住了全部遊戲服務因此無法使用的狀態。若與以上事由無關時請經過本人確認流程更詳細事項請透過PlayNC
	 * 網頁(www。plaync。co。kr) 客服洽詢。
	 */
	public static final int $1117 = 1117;
	/** 您的帳號是惡用NC coin相關bug而限制使用。更詳細事項請透過客服專線(Tel。1600-0020) 洽詢。 */
	public static final int $1118 = 1118;
	/** 您的帳號是惡用免費支付的 coin而限制使用。更詳細事項請透過客服專線。更詳細事項請透過客服專線(Tel。1600-0020) 洽詢。 */
	public static final int $1119 = 1119;
	/** 您的帳號是限制全部權限的狀態。更詳細事項請透過客服專線(Tel。1600-0020) 洽詢。 */
	public static final int $1120 = 1120;
	/**
	 * 您的帳號是限制全部權限的狀態。更詳細事項請透過客服專線(Tel。1600-0020) 洽詢。須要依PlayNC
	 * 綜合帳號登入的話，須在輸入帳號下方的 'PlayNC 綜合帳號'欄位確認。若不是，PlayNC 綜合帳號，請確認密碼位置數是否正確。天堂帳號
	 * 密碼位置數最多可輸到 13位，PlayNC 綜合帳號最多可輸到16。
	 */
	public static final int $1121 = 1121;
	/**
	 * 不是PlayNC 綜合帳號，或 帳號情報不一致。以Lineage 帳號登入的話，請取消PlayNC 綜合帳號
	 * 確認box選擇。若須要申請PlayNC 綜合帳號請到 www。plaync。co。kr申請。
	 */
	public static final int $1122 = 1122;
	/** 您的帳號須變更密碼及quiz才能登入。在PlayNC 網頁(www。plaync。co。kr)變更密碼及quiz 後利用服務。 */
	public static final int $1123 = 1123;
	/**
	 * 以PlayNC 綜合帳號登入的話，須在輸入帳號下方的 'PlayNC 綜合帳號'若不是，PlayNC 綜合帳號，請確認密碼位置數是否正確。天堂帳號
	 * 帳號位置數最多可輸到 12位，
	 */
	...
	/**
	 * 您的帳號確認到利用了商業性使用遊戲而鎖住了全部遊戲服務因此無法使用的狀態。更詳細事項請透過 PlayNC 網頁(www。plaync。co。kr)
	 * 客服洽詢。
	 */
	...
	/**
	 * 您是未接受實際名稱認證或未成年目前持有的帳號中其他帳號已登入中因此相關帳目無法登入。若您是成年人時為了正常進行遊戲請在
	 * 網頁(www。lineage。com。cn)中登入後接受實際人名認證。
	 */
	...
	/** %0位的選手正在等待，再過 %1秒後就要開始了。 */
	public static final int $1168 = 1168;
	/** %0位的選手已經開始比賽，時間已經過了 %1秒左右。 */
	...
	/** 等級25級以上的血盟君主才可以申請加入同盟。但聯盟君主無法加入其它同盟。 */
	...
	/**
	 * 已確認到你的帳號是利用別人的名義來申請的因此限制為無法使用所有遊戲服務的狀態. 更詳細的內容請尋問
	 * plaync(www.plaync.co.kr) 客服專線.
	 */
	public static final int $1295 = 1295;
	/** 目前有其他人在使用中，請稍待後晚點再嘗試。 */
	public static final int $1296 = 1296;
	/** 目前暫時停止移動到「天堂‧無界擂台」伺服器，請見諒。 */
	...
	/** 由於受到了魔法力量的保護，雖然產生激烈的 藍色的 光芒，但是裝備沒有消失。 */
	public static final int $1310 = 1310;
	/** 角色的素質獎勵點數與目前等級不符，為了符合素質獎勵點數將自動調整等級。 */
	...
	/** 材料:奎斯坦修的螯1個+綜合料理醬1個+香菜1個 (遠距離攻擊命中率+2及攻擊力+1) */
	public static final int $1394 = 1394;
	/** 材料:格利芬肉1個+綜合料理醬1個+香菜1個 (體力及魔力上限+50) */
	public static final int $1395 = 1395;
	/** 材料:亞力安的尾巴1個+綜合料理醬1個+香菜1個 (近距離攻擊命中率+2及攻擊力+1) */
	public static final int $1396 = 1396;
	/** 材料:巨王龜肉1個+綜合料理醬1個+香菜1個 (防禦-3) */
	public static final int $1397 = 1397;
	/** 材料:幼龍翅膀1個+綜合料理醬1個+香菜1個 (魔防+15及全屬性防禦+10。) */
	public static final int $1398 = 1398;
	/** 材料:飛龍肉1個+綜合料理醬1個+香菜1個 (魔攻+2與魔力回復量+2) */
	public static final int $1399 = 1399;
	/** 材料:深海魚肉1個+綜合料理醬1個+香菜1個 (體力上限+30，體力回復量+2) */
	public static final int $1400 = 1400;
	/** 材料:邪惡蜥蜴蛋1個+蘑菇汁1個+綜合料理醬1個+香菜1個 (狩獵經驗值增加了一些。) */
	...
	/** 活動期間中以各伺服器別只能產生1個角色，若有開啟新伺服器角色可追加產生。 */
	...
	/** 時空裂痕開啟了，裂痕的力量減弱，因此關閉時間呈現被延後的狀態... */
	...
	/**
	 * 推測您的遊戲帳號是非正常管道取得的，該遊戲帳號就會受到臨時限制。要是玩家沒有使用非正式帳號的話，可以到官網上進行封印認證，並且可以使用正式伺服器。
	...
	/** 確認為您是未成年或是沒認證到的id.若少確認到id情報請到官網修正 */
	...
	/** 侏儒的呼喚：喀瑪族為了守護巨龍將會到這裡來工作，他們就快到這裡了。 */
	public static final int $1588 = 1588;
	/** 侏儒的呼喚：喀瑪族是以礦物為主食的種族，雖然智能比較低，但是很有力氣。 */
	public static final int $1589 = 1589;
	/** 侏儒的呼喚：為了守護地龍安塔瑞斯，闇龍哈爾巴斯已經派人過去駐守了。 */
	public static final int $1590 = 1590;
	/** 侏儒的呼喚：啊...他們已經來了，大家一定要小心！！ */
	public static final int $1591 = 1591;
	/** 侏儒的呼喚：守門人已經出現了！ 一定要打倒他才可以通過這裡。 */
	...
	/** 安塔瑞斯：我可以原諒你的無禮..! 但今日是該做個了結了! */
	public static final int $1608 = 1608;
	/** 卡瑞：我不想再失去我們的勇者了，我會用我僅存的力量守護你們。 */
	...
	/** 地龍和水龍的氣息產生合併效應，並已穿透全身。 */
	public static final int $1613 = 1613;
	/** 地龍和水龍、風龍的氣息產生合併效應，並已穿透全身。 */
	public static final int $1614 = 1614;
	/** 地龍和水龍、風龍、火龍的氣息產生合併效應，並已穿透全身。 */
	...
	/** 角色專用倉庫的空間不足，無法再存放道具，必須使用指定道具擴充才可以使用。 */
	...
	/** 每日上午 8 點到 12 點為止，暫時無法使用龍之鑰匙。 */
	public static final int $1643 = 1643;
	/** 好像因為受到法利昂的血痕影響，變得更加厲害。 */
	...
	/** 巫女莎爾：那時我是那麼地信任你...可是現在不同！ */
	public static final int $1660 = 1660;
	/** 法利昂：可憐啊！他們就是和你一樣，註定要當我的祭品！ */
	...
	/** 法利昂：莎爾...你這個傢伙...怎麼...對得起我的母親...席琳啊...請拿走...我的生命吧... */
	public static final int $1668 = 1668;
	/** 巫女莎爾：謝謝…你們果然是亞丁最厲害的勇士。終於…伊娃王國古老的詛咒總算可以解除了。 */
	public static final int $1669 = 1669;
	/** 法利昂：現在已經玩完了吧。你們無法再躲過我的詛咒了！ */
	public static final int $1670 = 1670;
	/** 巫女莎爾：現在我用盡我最後的力量去召喚勇士。但已經沒辦法了。 */
	...
	/** 巴杰休的吶喊：阿爾波斯們馬上就會聚集過來。要做好一切準備。 */
	public static final int $1679 = 1679;
	/** 巴杰休的吶喊：他們具有高智慧和柔軟的身體，要特別小心觸角多的傢伙。 */
	public static final int $1680 = 1680;
	/** 巴杰休的吶喊：阿爾波斯是為了守護法利昂的安息，是闇龍哈爾巴斯派來的手下。 */
	public static final int $1681 = 1681;
	/** 巴仕休的吶喊：讓法利昂停止呼吸的勇士們出現了。！！ */
	public static final int $1682 = 1682;
	/** 巫女莎爾：屠龍勇士們！準備好讓法利昂沉睡嗎？ */
	...
	/** 增加攻擊成功、額外攻擊點數、魔攻、體力／魔力上限及回復量、傷害減免。 */
	public static final int $1689 = 1689;
	/** 增加攻擊成功、魔攻、體力上限、魔力上限、傷害減免。 */
	...
	/** 獲得敏捷+1，攻擊命中率+5，遠距離攻擊+3的效果。 */
	public static final int $1719 = 1719;
	/** 獲得力量+1，攻擊成功+5，額外攻擊點數+3的效果。 */
	public static final int $1720 = 1720;
	/** 獲得智力+1，魔力上限+50，魔力回復量+5的效果。 */
	...
	/**
	 * 巴風特伺服器，只有在天堂保安服務NCOTP、PC登錄、電話認證服務中加入1個以上的客戶才能使用。
