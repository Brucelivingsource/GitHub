...
public class S_AttackPacket extends ServerBasePacket {
	...
	public S_AttackPacket(LsimulatorCharacter atk, int objid, int[] data) {
		buildpacket(atk, objid, data);
	}

	public S_AttackPacket(LsimulatorCharacter atk, int objid, int actid) {
		int[] data = {actid, 0, 0};
		buildpacket(atk, objid, data);
	}

	private void buildpacket(LsimulatorCharacter atk, int objid, int[] data) { // data = {actid, dmg, effect}
