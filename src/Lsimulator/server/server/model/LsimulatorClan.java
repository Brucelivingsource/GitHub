...
public class LsimulatorClan {
	...
	private static final Logger _log = Logger.getLogger(LsimulatorClan.class.getName());
	...
	private final LsimulatorDwarfForClanInventory _dwarfForClan = new LsimulatorDwarfForClanInventory(this);
	...
	public LsimulatorDwarfForClanInventory getDwarfForClanInventory() {
