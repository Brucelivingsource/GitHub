...
public class NpcTable {
	...
	private final Map<Integer, LsimulatorNpc> _npcs = Maps.newMap();
	...
	private Constructor<?> getConstructor(String implName) {
		try {
			String implFullName = "Lsimulator.server.server.model.Instance." + implName + "Instance";
	...
	private void loadNpcData() {
		...
		try {
			...
			while (rs.next()) {
				LsimulatorNpc npc = new LsimulatorNpc();
	...
	public LsimulatorNpc getTemplate(int id) {
		return _npcs.get(id);
	}
	...
	public int findNpcIdByName(String name) {
		for (LsimulatorNpc npc : _npcs.values()) {
