...
public class MagicDollTable {
	...
	private final HashMap<Integer, LsimulatorMagicDoll> _dolls = new HashMap<Integer, LsimulatorMagicDoll>();
	...
	private void load() {
		...
		try {
			...
			while (rs.next()) {
				LsimulatorMagicDoll doll = new LsimulatorMagicDoll();
	...
	public LsimulatorMagicDoll getTemplate(int itemId) {
