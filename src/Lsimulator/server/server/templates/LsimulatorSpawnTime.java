...
import Lsimulator.server.server.utils.TimePeriod;

public class LsimulatorSpawnTime {
	...
	private LsimulatorSpawnTime(LsimulatorSpawnTimeBuilder builder) {
	...
	public static class LsimulatorSpawnTimeBuilder {
		private final int _spawnId;
		...
		public LsimulatorSpawnTimeBuilder(int spawnId) {
			_spawnId = spawnId;
		}

		public LsimulatorSpawnTime build() {
			return new LsimulatorSpawnTime(this);
		}
