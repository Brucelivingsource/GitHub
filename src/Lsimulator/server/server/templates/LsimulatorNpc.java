...
public class LsimulatorNpc extends LsimulatorObject implements Cloneable {
	/**
	 * 
	 */
	...
	@Override
	public LsimulatorNpc clone() {
		try {
			return (LsimulatorNpc) (super.clone());
		} catch (CloneNotSupportedException e) {
			throw (new InternalError(e.getMessage()));
		}
	}

	public LsimulatorNpc() {
	}
