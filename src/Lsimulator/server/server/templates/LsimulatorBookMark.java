...
public class LsimulatorBookMark {
	private static Logger _log = Logger.getLogger(LsimulatorBookMark.class.getName());
...
//		}
		...
		if (pc.getBookMark(s) == null) {
			LsimulatorBookMark bookmark = new LsimulatorBookMark();
