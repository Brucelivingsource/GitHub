...
public class CrownInstance extends NpcInstance {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public CrownInstance(LsimulatorNpc template) {
		super(template);
	}
	...
	private boolean checkRange(PcInstance pc) {
