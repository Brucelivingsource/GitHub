...
public class RequestInstance extends NpcInstance {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger _log = Logger.getLogger(RequestInstance.class
			.getName());

	public RequestInstance(LsimulatorNpc template) {
		super(template);
	}
