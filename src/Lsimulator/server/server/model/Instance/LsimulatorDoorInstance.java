...
import Lsimulator.server.server.serverpackets.S_Door;
import Lsimulator.server.server.serverpackets.S_DoorPack;
...
public class LsimulatorDoorInstance extends LsimulatorNpcInstance {

	private static final long serialVersionUID = 1L;
	private static final int DOOR_NPC_ID = 81158;

	public LsimulatorDoorInstance(LsimulatorNpc template) {
		super(template);
	}

	public LsimulatorDoorInstance(int doorId, LsimulatorDoorGfx gfx, LsimulatorLocation loc, int hp,
	...
	public void onAction(LsimulatorPcInstance pc) {
		...
		if (getCurrentHp() > 0 && !isDead()) {
			LsimulatorAttack attack = new LsimulatorAttack(pc, this);
			if (attack.calcHit()) {
				attack.calcDamage();
	...
	public void sendDoorPacket(LsimulatorPcInstance pc) {
	...
	private void sendPacket(LsimulatorPcInstance pc, int x, int y) {
