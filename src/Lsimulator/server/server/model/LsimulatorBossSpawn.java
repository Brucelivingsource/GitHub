...
public class LsimulatorBossSpawn extends LsimulatorSpawn {
	private static Logger _log = Logger.getLogger(LsimulatorBossSpawn.class.getName());
	...
	public LsimulatorBossSpawn(LsimulatorNpc mobTemplate) {
		super(mobTemplate);
	}
	...
	private LsimulatorBossCycle _cycle;
	...
	public void init() {
		...
		_cycle = LsimulatorBossCycle.getBossCycle(_cycleType);
		if (_cycle == null) {
