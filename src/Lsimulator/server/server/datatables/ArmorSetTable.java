...
public class ArmorSetTable {
	...
	private final List<LsimulatorArmorSets> _armorSetList = Lists.newList();
	...
	private void fillTable(ResultSet rs) throws SQLException {
		while (rs.next()) {
			LsimulatorArmorSets as = new LsimulatorArmorSets();
	...
	public LsimulatorArmorSets[] getAllList() {
		return _armorSetList.toArray(new LsimulatorArmorSets[_armorSetList.size()]);
	}
