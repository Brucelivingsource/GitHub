...
public class LsimulatorMagic {
	...
	public int calcPcFireWallDamage() {
		int dmg = 0;
		double attrDeffence = calcAttrResistance(LsimulatorSkills.ATTR_FIRE);
		LsimulatorSkills l1skills = SkillsTable.getInstance().getTemplate(FIRE_WALL);
