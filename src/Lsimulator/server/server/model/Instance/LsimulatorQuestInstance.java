...
public class LsimulatorQuestInstance extends LsimulatorNpcInstance {
	...
	public LsimulatorQuestInstance(LsimulatorNpc template) {
		super(template);
	}
	...
	public void onFinalAction(LsimulatorPcInstance pc, String action) {
		if (action.equalsIgnoreCase("start")) {
			...
			if (((npcId == 71092) || (npcId == 71093)) && pc.isKnight() && (pc.getQuest().get_step(3) == 4)) {
				...
				new LsimulatorFollowerInstance(l1npc, this, pc);
