...
public class LsimulatorMobSkill implements Cloneable {
	...
	@Override
	public LsimulatorMobSkill clone() {
		try {
			return (LsimulatorMobSkill) (super.clone());
	...
	public LsimulatorMobSkill(int sSize) {
		skillSize = sSize;
