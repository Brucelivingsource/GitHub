...
/**
 * LsimulatorMap マップ情報を保持し、それに対する様々なインターフェースを提供する。
 */
public abstract class LsimulatorMap {
	private static LsimulatorNullMap _nullMap = new LsimulatorNullMap();

	protected LsimulatorMap() {
	}
	 ...
	 * LsimulatorMapの利用者は通常、マップにどのような値が格納されているかを知る必要はありません。
	...
	public static LsimulatorMap newNull() {
		return _nullMap;
	}
 ...
 * 何もしないMap。
 */
class LsimulatorNullMap extends LsimulatorMap {
	public LsimulatorNullMap() {
	}
