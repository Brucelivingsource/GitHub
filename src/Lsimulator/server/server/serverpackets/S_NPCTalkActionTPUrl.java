...
public class S_NPCTalkActionTPUrl extends ServerBasePacket {
	...
	public S_NPCTalkActionTPUrl(LsimulatorNpcTalkData cha, Object[] prices, int objid) {
		buildPacket(cha, prices, objid);
	}

	private void buildPacket(LsimulatorNpcTalkData npc, Object[] prices, int objid) {
		String htmlid = "";
