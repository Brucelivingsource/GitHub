...
public class S_RangeSkill extends ServerBasePacket {
	...
	public S_RangeSkill(LsimulatorCharacter cha, LsimulatorCharacter[] target, int spellgfx, int actionId, int type) {
		buildPacket(cha, target, spellgfx, actionId, type);
	}

	private void buildPacket(LsimulatorCharacter cha, LsimulatorCharacter[] target, int spellgfx, int actionId, int type) {
		...
		for (LsimulatorCharacter element : target) {
