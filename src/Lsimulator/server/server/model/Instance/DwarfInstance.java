...
public class DwarfInstance extends NpcInstance {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private static Logger _log = Logger.getLogger(DwarfInstance.class
			.getName());

	/**
	 * @param template
	 */
	public DwarfInstance(LsimulatorNpc template) {
		super(template);
	}
