...
public class LsimulatorScarecrowInstance extends LsimulatorNpcInstance {

	private static final long serialVersionUID = 1L;

	public LsimulatorScarecrowInstance(LsimulatorNpc template) {
		super(template);
	}
	...
	@Override
	public void onTalkAction(LsimulatorPcInstance l1pcinstance) {
