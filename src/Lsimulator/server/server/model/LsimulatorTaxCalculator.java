...
public class LsimulatorTaxCalculator {
	/**
	 * 戦争税は15%固定
	 */
	 ...
	 *            計算対象商店のNPCID
	 */
	public LsimulatorTaxCalculator(int merchantNpcId) {
		_taxRatesCastle = LsimulatorCastleLocation.getCastleTaxRateByNpcId(merchantNpcId);
		_taxRatesTown = LsimulatorTownLocation.getTownTaxRateByNpcid(merchantNpcId);
	}
