...
public class PetItemTable {
	...
	private final Map<Integer, LsimulatorPetItem> _petItemIdIndex = Maps.newMap();
	...
	private void fillPetItemTable(ResultSet rs) throws SQLException {
		while (rs.next()) {
			LsimulatorPetItem petItem = new LsimulatorPetItem();
	...
	public LsimulatorPetItem getTemplate(int itemId) {
