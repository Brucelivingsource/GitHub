...
public class TownTable {
	...
	private final Map<Integer, LsimulatorTown> _towns = Maps.newConcurrentMap();
	...
	public void load() {
		...
		try {
			...
			while (rs.next()) {
				LsimulatorTown town = new LsimulatorTown();
	...
	public LsimulatorTown[] getTownTableList() {
		return _towns.values().toArray(new LsimulatorTown[_towns.size()]);
	}

	public LsimulatorTown getTownTable(int id) {
