...
public class LsimulatorDoorGfx {
	private static Logger _log = Logger.getLogger(LsimulatorDoorGfx.class.getName());
	private final int _gfxId;
	private final int _direction;
	private final int _rightEdgeOffset;
	private final int _leftEdgeOffset;

	private LsimulatorDoorGfx(int gfxId, int direction, int rightEdgeOffset,
			int leftEdgeOffset) {
		_gfxId = gfxId;
	 ...
	 * @return
	 */
	public static LsimulatorDoorGfx findByGfxId(int gfxId) {
		Connection con = null;
		...
		try {
			...
			return new LsimulatorDoorGfx(id, dir, rEdge, lEdge);
