...
import Lsimulator.server.server.model.LsimulatorWeaponSkill;
...
public class WeaponSkillTable {
	...
	private final Map<Integer, LsimulatorWeaponSkill> _weaponIdIndex = Maps.newMap();
	...
	private void fillWeaponSkillTable(ResultSet rs) throws SQLException {
		while (rs.next()) {
			...
			LsimulatorWeaponSkill weaponSkill = new LsimulatorWeaponSkill(weaponId, probability, fixDamage, randomDamage, area, skillId, skillTime, effectId,
	...
	public LsimulatorWeaponSkill getTemplate(int weaponId) {
