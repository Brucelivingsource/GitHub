...
public final class Config {
	...
	/** Server control */
	public static String WORLD_SERVER_HOST_NAME;
	...
	public static void load() {
		...
		try {
			...
			WORLD_SERVER_HOST_NAME = serverSettings.getProperty("WorldServerHostname", "*");
			WORLD_SERVER_PORT = Integer.parseInt(serverSettings.getProperty("WorldServerPort", "2000"));
			DB_DRIVER = serverSettings.getProperty("Driver", "com.mysql.jdbc.Driver");
			DB_URL = serverSettings.getProperty("URL", "jdbc:mysql://localhost/myserverdb?useUnicode=true&characterEncoding=utf8");
	...
	public static boolean setParameterValue(String pName, String pValue) {
		...
		if (pName.equalsIgnoreCase("GameserverHostname")) {
			WORLD_SERVER_HOST_NAME = pValue;
		}
		else if (pName.equalsIgnoreCase("GameserverPort")) {
			WORLD_SERVER_PORT = Integer.parseInt(pValue);
		}
