...
public class LsimulatorV1Map extends LsimulatorMap {
	...
	protected LsimulatorV1Map() {

	}

	public LsimulatorV1Map(int mapId, byte map[][], int worldTopLeftX, int worldTopLeftY, boolean underwater, boolean markable, boolean teleportable,
	...
	public LsimulatorV1Map(LsimulatorV1Map map) {
		_mapId = map._mapId;
