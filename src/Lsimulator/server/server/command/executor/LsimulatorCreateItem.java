 ...
 * GM指令：創立道具
 */
public class LsimulatorCreateItem implements LsimulatorCommandExecutor {
	private static Logger _log = Logger.getLogger(LsimulatorCreateItem.class.getName());

	private LsimulatorCreateItem() {
	}

	public static LsimulatorCommandExecutor getInstance() {
		return new LsimulatorCreateItem();
	}
