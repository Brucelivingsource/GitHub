...
public class PetTypeTable {
	...
	private Map<Integer, LsimulatorPetType> _types = Maps.newMap();
	...
	private void loadTypes() {
		...
		try {
			...
			while (rs.next()) {
				...
				_types.put(baseNpcId, new LsimulatorPetType(baseNpcId, name, itemIdForTaming, hpUpRange, mpUpRange, evolvItemId, npcIdForEvolving, msgIds, defyMsgId, canUseEquipment));
	...
	public LsimulatorPetType get(int baseNpcId) {
