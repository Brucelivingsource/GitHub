...
public class DoorInstance extends NpcInstance {

	private static final long serialVersionUID = 1L;
	private static final int DOOR_NPC_ID = 81158;

	public DoorInstance(LsimulatorNpc template) {
		super(template);
	}

	public DoorInstance(int doorId, LsimulatorDoorGfx gfx, LsimulatorLocation loc, int hp,
	...
	private void updateStatus() {
		...
		} else if ( ( (getMaxHp() << 1 )  / 6) > getCurrentHp()) {
	...
	public void sendDoorPacket(PcInstance pc) {
	...
	private void sendPacket(PcInstance pc, int x, int y) {
