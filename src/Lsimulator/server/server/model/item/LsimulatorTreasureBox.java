 ...
 * 
 */
package Lsimulator.server.server.model.item;
...
public class LsimulatorTreasureBox {

	private static Logger _log = Logger
			.getLogger(LsimulatorTreasureBox.class.getName());

	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlRootElement(name = "TreasureBoxList")
	private static class TreasureBoxList implements Iterable<LsimulatorTreasureBox> {
		@XmlElement(name = "TreasureBox")
		private List<LsimulatorTreasureBox> _list;

		@Override
		public Iterator<LsimulatorTreasureBox> iterator() {
	...
	private static final Map<Integer, LsimulatorTreasureBox> _dataMap = Maps.newMap();
	 ...
	 */
	public static LsimulatorTreasureBox get(int id) {
	...
	public static void load() {
		...
		try {
			JAXBContext context = JAXBContext
					.newInstance(LsimulatorTreasureBox.TreasureBoxList.class);
			...
			for (LsimulatorTreasureBox each : list) {
				each.init();
