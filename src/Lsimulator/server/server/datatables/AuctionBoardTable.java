...
public class AuctionBoardTable {
	...
	private final Map<Integer, LsimulatorAuctionBoard> _boards = Maps.newConcurrentMap();
	...
	public LsimulatorAuctionBoard[] getAuctionBoardTableList() {
		return _boards.values().toArray(new LsimulatorAuctionBoard[_boards.size()]);
	}

	public LsimulatorAuctionBoard getAuctionBoardTable(int houseId) {
		return _boards.get(houseId);
	}

	public void insertAuctionBoard(LsimulatorAuctionBoard board) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = LsimulatorDatabaseFactory.getInstance().getConnection();
	...
	public void updateAuctionBoard(LsimulatorAuctionBoard board) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = LsimulatorDatabaseFactory.getInstance().getConnection();
