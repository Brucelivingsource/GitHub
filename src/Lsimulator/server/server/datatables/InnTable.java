...
public class InnTable {
	...
	private static class Inn {
		private final Map<Integer, LsimulatorInn> _inn = Maps.newMap();
	}
	...
	public void updateInn(LsimulatorInn inn) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = LsimulatorDatabaseFactory.getInstance().getConnection();
	...
	public LsimulatorInn getTemplate(int npcid, int roomNumber) {
