...
public class LsimulatorFishInstance extends LsimulatorNpcInstance {

	private static final long serialVersionUID = 1L;
	private fishTimer _fishTimer;

	public LsimulatorFishInstance(LsimulatorNpc template) {
		super(template);
	...
	private class fishTimer extends TimerTask {
		...
		private LsimulatorFishInstance _fish;

		public fishTimer(LsimulatorFishInstance fish) {
			_fish = fish;
		}
