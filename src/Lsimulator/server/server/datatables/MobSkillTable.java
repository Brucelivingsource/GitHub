...
public class MobSkillTable {
	...
	private final Map<Integer, LsimulatorMobSkill> _mobskills;
		...
		try {
			...
			for (rs1 = pstm1.executeQuery(); rs1.next();) {
				...
				try {
					...
					LsimulatorMobSkill mobskill = new LsimulatorMobSkill(count);
	...
	public LsimulatorMobSkill getTemplate(int id) {
