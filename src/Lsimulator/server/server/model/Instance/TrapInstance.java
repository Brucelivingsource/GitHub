...
public class TrapInstance extends LsimulatorObject {
	/**
	 * 
	 */
	...
	private List<PcInstance> _knownPlayers = Lists.newConcurrentList();

	public TrapInstance(int id, LsimulatorTrap trap, LsimulatorLocation loc, Point rndPt, int span) {
		setId(id);
		_trap = trap;
		getLocation().set(loc);
		_baseLoc.set(loc);
	...
	public TrapInstance(int id, LsimulatorLocation loc) {
		setId(id);
	...
	public void disableTrap() {
		...
		for (PcInstance pc : _knownPlayers) {
	...
	public void onTrod(PcInstance trodFrom) {
