...
public class HomeTownTimeController {
	...
	private static LsimulatorTownFixedProcListener _listener;

	private void startListener() {
		if (_listener == null) {
			_listener = new LsimulatorTownFixedProcListener();
			LsimulatorGameTimeClock.getInstance().addListener(_listener);
		}
	}

	private class LsimulatorTownFixedProcListener extends LsimulatorGameTimeAdapter {
		@Override
	...
	private void fixedProc(LsimulatorGameTime time) {
	...
	public void monthlyProc() {
		...
		clearHomeTownID();
		LsimulatorWorld.getInstance().setProcessingContributionTotal(false);
	}
