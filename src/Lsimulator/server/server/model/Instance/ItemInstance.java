...
// LsimulatorObject, PcInstance

public class ItemInstance extends LsimulatorObject {
	...
	public ItemInstance(LsimulatorItem item, int count) {
		this();
		setItem(item);
		setCount(count);
	}
	...
	@Override
	public void onAction(PcInstance player) {
	}
	...
	public void setSkillArmorEnchant(PcInstance pc, int skillId, int skillTime) {
		int type = getItem().getType();
		int type2 = getItem().getType2();
		if (_isRunning) {
			_timer.cancel();
	...
	public void setSkillWeaponEnchant(PcInstance pc, int skillId,
			int skillTime) {
	...
	public void startItemOwnerTimer(PcInstance pc) {
	...
	public void startEquipmentTimer(PcInstance pc) {
		if (getRemainingTime() > 0) {
	...
	public void stopEquipmentTimer(PcInstance pc) {
		if (getRemainingTime() > 0) {
