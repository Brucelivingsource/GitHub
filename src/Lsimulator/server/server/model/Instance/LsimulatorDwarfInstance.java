...
public class LsimulatorDwarfInstance extends LsimulatorNpcInstance {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private static Logger _log = Logger.getLogger(LsimulatorDwarfInstance.class
			.getName());

	/**
	 * @param template
	 */
	public LsimulatorDwarfInstance(LsimulatorNpc template) {
		super(template);
	}
